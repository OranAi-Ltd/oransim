...
v0.1.0-alpha 的快速上手见根目录 [README.zh-CN.md](https://github.com/ORAN-cgsj/oransim/blob/main/README.zh-CN.md#-一分钟上手)。
...
完整后端到位时间见 [ROADMAP.md](https://github.com/ORAN-cgsj/oransim/blob/main/ROADMAP.md)。
