...
v0.1.0-alpha benchmark numbers in the root README are produced from **100k synthetic samples**. They are not directly comparable to real-world production traffic. See [`data/models/data_card.md`](../../../data/models/data_card.md) for data-generating process.
