...
For v0.1.0-alpha, see the root [README.md](https://github.com/ORAN-cgsj/oransim/blob/main/README.md#-quickstart-60-seconds).
...
See [ROADMAP.md](https://github.com/ORAN-cgsj/oransim/blob/main/ROADMAP.md) for when the full backend lands.
