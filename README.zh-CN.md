...
> **注意**：v0.1.0-alpha 只含骨架代码，完整后端在 v0.2 到位（见 [ROADMAP.md](ROADMAP.md)）。关注仓库等待后续更新。
...
**想要其他平台？** 提 [Adapter Request](https://github.com/oranai/oransim/issues/new?template=adapter_request.yml) —— 我们根据社区需求优先级排序。
...
- **新手友好 issue**：[按标签筛选](https://github.com/oranai/oransim/issues?q=is%3Aissue+label%3A%22good+first+issue%22)
- **平台 adapter 请求**：[在这里提](https://github.com/oranai/oransim/issues/new?template=adapter_request.yml)
