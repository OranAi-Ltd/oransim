...
Use the [Bug Report issue template](https://github.com/oranai/oransim/issues/new?template=bug_report.yml).

## Proposing Features

For significant features, open a [Feature Request](https://github.com/oranai/oransim/issues/new?template=feature_request.yml) or start a [Discussion](https://github.com/oranai/oransim/discussions) first to align on approach before coding.

## Platform Adapter Requests

Want support for a platform we haven't covered yet (e.g., LinkedIn, Pinterest)? File an [Adapter Request](https://github.com/oranai/oransim/issues/new?template=adapter_request.yml).

## Community

- **Discussions**: https://github.com/oranai/oransim/discussions
- **Issues**: https://github.com/oranai/oransim/issues
